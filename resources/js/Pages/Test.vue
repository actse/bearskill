    ...
    <section>
        ...
        >
            <div class="flex flex-row w-full">
                <div
                    class="flex flex-col p-10 w-full min-h-screen text-gray-700"
                >
                    <div
                    ...
                    <!-- รูปภาพ -->
                    <div
                        class="flex mb-4 w-full h-auto items-center justify-center"
                    >
                    ...
                    <div
                        class="flex w-full h-10 mb-4 mt-6 bg-[#151F32] text-white items-center justify-center rounded"
                    >
                    ...
                    <div class="mb-4">
                        <label
                            ...
                            class="block font-bold mb-2"
                            >ยกตัวอย่างการสอน / รายละเอียดเนื้อหาการสอน</label
                        >
                        <textarea
                ...
                <div class="flex flex-col p-10 w-full text-gray-700">
                    <div
                        class="flex w-full h-10 mb-4 bg-[#151F32] text-white items-center justify-center rounded"
                    >
                        ข้อมูลส่วนตัว
                    ...
                    <!-- รูปภาพ -->
                    <div class="mb-4">
                        <label for="teacher_image" class="block font-bold mb-2"
                            >รูปโปรไฟล์</label
                        >
                        <input
                            type="file"
                    ...
                    <div class="flex flex-row mb-4">
                        <div class="w-1/2 mr-2">
                            <label for="first_name" class="block font-bold mb-2"
                                >ชื่อ</label
                            >
                            <input
                                type="text"
                        ...
                        <div class="w-1/2 ml-2">
                            <label for="last_name" class="block font-bold mb-2"
                                >นามสกุล</label
                            >
                            <input
                                type="text"
                    ...
                    <div class="flex flex-row mb-4">
                        <div class="w-1/2 mr-2">
                            <label for="nickname" class="block font-bold mb-2"
                                >ชื่อเล่น</label
                            >
                            <input
                                type="text"
                    ...
                    <!-- เอกสาร -->
                    <div class="mb-4">
                        <label for="idcard_image" class="block font-bold mb-2"
