...
<template>
    <LayoutPage>
        <div class="max-w-7xl mx-auto py-10">
            <div
                class="flex bg-white overflow-hidden shadow-sm sm:rounded-lg items-center justify-center"
            >
                <form
                    class="w-full"
                    @submit.prevent="updatadata_tutor"
                ...
                >
                    ...
                    <div
                        class="flex flex-row items-center justify-center mb-10"
                    >
                        <div class="flex-col">
                            <button
                                type="submit"
...
export default {
    ...
    methods: {
        ...
        register_tutor() {
            ...
            axios
                .post("/addtutordetail_data", formData)
                .then((response) => {})
                .catch((error) => {
                    console.log(error);
                });
